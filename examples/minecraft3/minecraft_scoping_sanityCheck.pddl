...
(:objects
	...
	; wb0 wb1 wb2 wb3 wb4 wb5 wb6 wb7 wb8 wb9 wb10 - wooden-block
...
; Somehow, the axe is not relevant as long as there are 11 wooden blocks or less?
; >1 orchid flowers also makes axe relevant - probably because of same issue as Taxi? (look into this to be sure!)
...
; iter to the next...
(:goal (and (>= (agent-num-orchid-flower steve) 1))
)
