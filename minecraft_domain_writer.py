...
def make_instance_1(start_with_pick = True, use_bedrock_boundaries = False, add_irrel_items = False, goal_var = ""):
    ...
    state_space_underestimate_s = f"; State space size: > {state_space_underestimate}"
    prob_parts = [header, object_declaration, init_conds, goal, state_space_underestimate_s, ")"]
    prob_s = "\n\n\n".join(prob_parts)
    return prob_s
