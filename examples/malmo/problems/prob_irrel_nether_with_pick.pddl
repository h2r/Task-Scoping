    ...
    <Mission xmlns="http://ProjectMalmo.microsoft.com" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
        ...
        <ServerSection>
            ...
            <ServerHandlers>
                ...
                <DrawingDecorator>
                    <DrawCuboid x1="-1" y1="199" z1="-12" x2="9" y2="202" z2="1" type="bedrock"/>
<DrawCuboid x1="0" y1="200" z1="-11" x2="8" y2="201" z2="0" type="air"/>
        ...
        <AgentSection mode="Survival">
            ...
            <AgentHandlers>
                ...
                <ObservationFromNearbyEntities>
                    <Range name="entities" xrange="9'" yrange="2" zrange="12" />
                </ObservationFromNearbyEntities>
