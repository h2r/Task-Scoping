...
if __name__ == "__main__":
    dom_s = make_domain()
    with open("examples/minecraft_housebuilding/minecraft-wood_stupa.pddl","w") as f:
        f.write(dom_s)
    prob_s, malmo_s = make_instance_1(start_with_pick=False, add_irrel_items=False, goal_var="build_oak_stupa_simple")
    with open("examples/minecraft_housebuilding/prob_stupa_with_pick.pddl","w") as f:
        f.write(prob_s)
