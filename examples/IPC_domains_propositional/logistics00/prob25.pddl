...
(:objects apn2 apn1 apt5 pos5 apt4 pos4 apt3 pos3 apt2 pos2 apt1 pos1 cit5 cit4 cit3 cit2 cit1 tru5 tru4 tru3 tru2 tru1 
          ...
          obj65 obj64 obj63 obj62 obj61 obj75 obj74 obj73 obj72 obj71
...
(:init (package obj11) (package obj12) (package obj13) (package obj21)
 ...
 (at obj65 pos5) (at obj64 pos4) (at obj63 pos3) (at obj62 pos2) (at obj61 pos1)
 (at obj75 pos5) (at obj74 pos4) (at obj73 pos3) (at obj72 pos2) (at obj71 pos1)
 ...
 (in-city apt5 cit5))
(:goal  
        ; Goal displaying conditional irrelevance
        (and (at obj22 apt4) (at obj31 apt4) (at obj43 pos5) 
            (at obj13 apt5) (at obj23 pos5) (at obj12 pos3) 
            (at obj51 pos5) (at obj32 pos3) (at obj11 pos1) 
            (at obj42 pos4) (at obj52 pos5) (at obj33 pos3)
            (at obj21 pos2) (at obj53 pos5) (at obj41 pos4)
            (at obj65 pos5) (at obj64 pos4) (at obj63 pos3) 
            (at obj62 pos2) (at obj61 pos1)
            (at obj75 pos5) (at obj74 pos4) (at obj73 pos3)
            (at obj72 pos2) (at obj71 pos1)
        )
)
        ; Original goal
        ; (and (at obj22 apt4) (at obj31 apt4) (at obj43 pos5) 
        ;     (at obj13 apt1) (at obj23 pos4) (at obj12 pos2) 
        ;     (at obj51 pos3) (at obj32 pos3) (at obj11 apt3) 
        ;     (at obj42 apt2) (at obj52 apt4) (at obj33 apt3)
        ;     (at obj21 pos3) (at obj53 apt2) (at obj41 pos4)))
)
