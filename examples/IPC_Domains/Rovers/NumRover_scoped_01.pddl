...
(:predicates (located-at ?x - rover ?y - waypoint) 
...
:precondition (and (located-at ?x ?w) (in_sun ?w) (<= (energy ?x) 80))
...
(:action calibrate
 ...
 :precondition (and (equipped_for_imaging ?r) (>= (energy ?r) 2)(calibration_target ?i ?t) (located-at ?r ?w) (visible_from ?t ?w)(on_board ?i ?r)
		)
...
(:action communicate_image_data
 ...
 :precondition (and (located-at ?r ?x)(at_lander ?l ?y)(have_image ?r ?o ?m)(visible ?x ?y)(available ?r)(channel_free ?l)(>= (energy ?r) 6)
            )
 :effect (and (not (available ?r))(not (channel_free ?l))
(channel_free ?l)
